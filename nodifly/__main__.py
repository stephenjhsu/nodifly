...
def alert_type(starttime, endtime, duration, from_where, kind=None, alias='', key='', secret=''):
    if (kind != None) & (kind != 'email') & (kind != 'record') & (kind != 'text'):
        ...
        if from_where == 'jupyter':
            ...
            print('\033[1m' + 'Nodifly.com - Real-Time Notifications' + '\033[0m')
            print('\033[1m' + 'Program started at: ' + str(stimestr) + '\033[0m')
            print('\033[1m' + 'Program finished at: ' + str(etimestr) + '\033[0m')
            print('\033[1m' + 'Program took: ' + str(duration) + '\033[0m')
            print('\033[1m' + x['escalate']  + '\033[0m')
